"""
File: matrix.py
Mục đích: Định nghĩa class Matrix dùng chung cho toàn bộ dự án.

Trước đây class Matrix được định nghĩa trong notebook (Part1_demo.ipynb)
và inject vào builtins. Giờ tách ra file riêng để:
  - Các module .py có thể import trực tiếp
  - Notebook vẫn dùng bình thường (import từ file này thay vì định nghĩa lại)
